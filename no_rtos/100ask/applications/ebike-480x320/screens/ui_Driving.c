...
static void anim_update_battery_cb(void * var, int32_t v)
{
    lv_slider_set_value(ui_Slider_Battery, v, LV_ANIM_ON);
    lv_label_set_text_fmt(ui_Label_Battery_Number, "%d", v);
    lv_label_set_text_fmt(ui_Label_Charging_Number, "%d", v);

    lv_obj_set_y(ui_Wave1, 100 - v);
    lv_obj_set_y(ui_Wave2, 100 - v);
}

static void anim_update_speed_cb(void * var, int32_t v)
{
    lv_slider_set_value(ui_Slider_Speed, v, LV_ANIM_ON);
    lv_label_set_text_fmt(ui_Speed_Number_1, "%d", v);
    lv_label_set_text_fmt(ui_Speed_Number_2, "%d", v);
}
...
static void init_anim(void)
{
    ...
    lv_anim_set_exec_cb(&a, anim_update_battery_cb);
    ...
    lv_anim_t a2;
    lv_anim_init(&a2);
    lv_anim_set_var(&a2, NULL);
    lv_anim_set_values(&a2, 0, 50);
    lv_anim_set_time(&a2, 5000);
    lv_anim_set_playback_delay(&a2, 200);
    lv_anim_set_playback_time(&a2, 8000);
    lv_anim_set_repeat_delay(&a2, 500);
    lv_anim_set_exec_cb(&a2, anim_update_speed_cb);
    //lv_anim_set_path_cb(&a2, lv_anim_path_step);
...
lv_obj_set_height( ui_Slider_Speed, 278);
...
lv_obj_set_height( ui_Slider_Battery, 274);
